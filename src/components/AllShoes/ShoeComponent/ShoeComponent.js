  ...
  return (
    <div className="shoeComponent">
      ...
      <div className="shoeComponent__price">
        <span className="shoeComponent__before">Before: <span className="shoeComponent__beforePrice">Rm{before}</span></span>
        <span className="shoeComponent__after">Now: <span className="shoeComponent__afterPrice">RM{after}</span></span>
      </div>
